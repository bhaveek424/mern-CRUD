...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\nconst config = {\n  env: \"development\" || 0,\n  port: process.env.PORT || 8000,\n  jwtSecret: process.env.JWT_SECRET || \"bhaveek\",\n  mongoUrl: \"mongodb+srv://bhaveek:bhaveek1234@cluster0.ajarip0.mongodb.net/?retryWrites=true&w=majority\"\n};\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (config);\n\n//# sourceURL=webpack://crud/./config/config.js?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _config_config__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../config/config */ \"./config/config.js\");\n/* harmony import */ var _express__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./express */ \"./server/express.js\");\n/* harmony import */ var mongoose__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! mongoose */ \"mongoose\");\n/* harmony import */ var mongoose__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(mongoose__WEBPACK_IMPORTED_MODULE_2__);\n\n\n\n\n// Connection URL\n\nmongoose__WEBPACK_IMPORTED_MODULE_2___default().set(\"strictQuery\", false);\nmongoose__WEBPACK_IMPORTED_MODULE_2___default().connect(_config_config__WEBPACK_IMPORTED_MODULE_0__[\"default\"].mongoUrl, {\n  useNewUrlParser: true,\n  useUnifiedTopology: true\n}).then(() => _express__WEBPACK_IMPORTED_MODULE_1__[\"default\"].listen(_config_config__WEBPACK_IMPORTED_MODULE_0__[\"default\"].port, () => console.log(`Server running on port: ${_config_config__WEBPACK_IMPORTED_MODULE_0__[\"default\"].port}`))).catch(error => console.log(error.message));\n\n//mongoose.set(\"useFindAndModify\", false);\n/*mongoose.connection.on(\"error\", () => {\n  throw new Error(`Unable to connect to database: ${CONNECTION_URL}`);\n}); */\n\n/*app.listen(PORT, (err) => {\n  if (err) {\n    console.log(err);\n  }\n  console.log(\"Server started on port %s.\", PORT);\n}); */\n\n//# sourceURL=webpack://crud/./server/server.js?");
